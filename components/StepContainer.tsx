        ...
        <>
          ...
          <div className={styles["body"]}>
            <div className={styles["footer"]} style={{ textAlign: 'center' }}>
              <button
                style={{ color: '#FFFFFF', cursor: 'pointer', width: '50%', padding: '1.2em', fontSize: '1.8rem', fontWeight: 700, borderRadius: '41px', background: '#5da60f', border: 'none', outline: 'none', boxShadow: 'none', transition: 'all 0.15s ease-in-out' }}
            ...
            <div>
              <BootstrapDialog
                ...
                open={open}
              >
                <div style={{ maxWidth: '560px', width: '100%', backgroundColor: '#110816' }}>
                  <div style={{ borderColor: 'rgb(41 33 46/var(--tw-border-opacity))', borderWidth: '1px', borderRadius: '.75rem', width: '100%', padding: '20px' }} >
                    How to pay with crypto
                  </div>
                  <section style={{ padding: '20px 10px 10px 10px' }}>
                    <div style={{ paddingTop: '0.5rem', paddingBottom: '0.5rem' }}>
                      <h3 style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))', fontWeight: 500, }}>Step 1.</h3>
                      <div style={{ padding: '16px 0', display: 'flex', }}>
                        ...
                        <p style={{ paddingLeft: '0.75rem', alignSelf: 'center', margin: 0 }}>Visit the <span style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))' }}>Purple Prison Crypto Exchange</span></p>
                      </div>
                    </div>

                    <div style={{ paddingTop: '0.5rem', paddingBottom: '0.5rem' }}>
                      <h3 style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))', fontWeight: 500, }}>Step 2.</h3>
                      <div style={{ padding: '16px 0', display: 'flex', }}>
                        ...
                        <p style={{ paddingLeft: '1.25rem', alignSelf: 'center', margin: 0 }}><span style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))' }}>Purple Prison Crypto Exchange</span>  and purchase
                          <strong style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))', fontWeight: 'bolder' }}> 4.40 <small>USD</small></strong> of store credit
                        </p>
                      </div>
                    </div>

                    <div style={{ paddingTop: '0.5rem', paddingBottom: '0.5rem' }}>
                      <h3 style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))', fontWeight: 500, }}>Step 3.</h3>
                      <div style={{ padding: '16px 0', display: 'flex', }}>
                        ...
                        <p style={{ paddingLeft: '1rem', alignSelf: 'center', margin: 0 }}><span style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))' }}>Redeem </span> your <span style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))' }}>store credit code</span> on <span style={{ color: 'rgb(255 255 255/var(--tw-text-opacity))' }}>this page</span></p>
                      </div>
                    </div>
                  </section>
                </div>
